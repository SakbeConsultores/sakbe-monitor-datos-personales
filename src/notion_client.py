...
class NotionClient:
    ...
    def _parse_page(page: dict) -> dict:
        ...
        return {
            ...
            # Region ("LatAm" / "Europa") es lo que alimenta las pestañas
            # del dashboard. Es la unica propiedad nueva respecto al
            # Monitor de Reguladores Financieros.
            "region": select_name(props.get("Region", {})),
    ...
    def insert_item(self, item: dict) -> bool:
        ...
        El item debe traer estas llaves:
            ...
            regulator, region, country, type, feed_url
        """
        properties = {
            "Título": {
